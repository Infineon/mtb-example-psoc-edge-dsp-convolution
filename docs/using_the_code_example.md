...
The following example clones the "[DSP convolution](https://github.com/Infineon/mtb-example-psoc-edge-dsp-convolution)" application with the desired name "DspConvolution" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-dsp-convolution --user-app-name DspConvolution --target-dir "C:/mtb_projects"
   ```
